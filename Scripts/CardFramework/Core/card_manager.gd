...
func _ready() -> void:
	...
	print("CardManager: Factory initialized with card_info_dir: ", card_factory.card_info_dir)
	print("CardManager: Factory initialized with card_asset_dir: ", card_factory.card_asset_dir)
